...
public class SuperAdminPanel {
    @FindBy(xpath = "/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/input[1]")
    WebElement txtPhone;
    @FindBy(xpath = "/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/div[1]/input[1]")
    WebElement txtPassword;
    @FindBy(xpath = "/html[1]/body[1]/div[1]/div[1]/div[1]/button[1]")
    WebElement btnLogin;
    @FindBy(xpath = "/html[1]/body[1]/div[1]/div[1]/div[1]/button[1]")
    WebElement btnLoginDisplayed;
    @FindBy(xpath = "/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/a[1]")
